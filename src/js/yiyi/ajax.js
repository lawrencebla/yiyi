...
(function(global, $) {
	...
	var ERROR_CODE_INTERFACE = -1;
	var ERROR_CODE_ENCRYPT = -2;
	var ERROR_CODE_FILE_NOT_FOUND = 1002;
	var ERROR_CODE_METHOD_NOT_FOUND = 1003;
	...
	global.yjax = function(action, param, success, error) {
		try {
